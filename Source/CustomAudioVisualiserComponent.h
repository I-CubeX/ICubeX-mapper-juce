...
#ifndef JUCE_CUSTOM_AUDIOVISUALISER_H_INCLUDED
#define JUCE_CUSTOM_AUDIOVISUALISER_H_INCLUDED
...
class CustomAudioVisualiserComponent  : public Component,
private Timer
{
   
public:
   /** Creates a visualiser with the given number of channels. */
   CustomAudioVisualiserComponent (int initialNumChannels);
   ...
   void setChColour(Colour waveformColour, int channel);
...
#endif  // JUCE_CUSTOM_AUDIOVISUALISER_H_INCLUDED
